...
const typeColors = {
  ...
  journaling: 'bg-surface-strong text-foreground border-border',
  fitness: 'bg-primary/15 text-primary border-primary/20',
} as const;
...
const Artifacts = ({ artifact,index }: ArtifactProps) => {
  ...
  return (
    <div
      className="group relative overflow-hidden rounded-2xl border border-border bg-card/90 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md"
    ...
    >
      <div className="p-6 space-y-4">
        ...
        <div className="relative pt-4 mt-6 border-t border-border/50">
          <div className="absolute left-0 top-0 h-px w-8 bg-section-rule"></div>
